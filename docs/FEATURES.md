...
| F-1.1 | Account CRUD + primary flag rules | 1.1 | `planned` | |
...
| F-2.1 | Transaction CRUD + payee autocomplete | 2.1 | `planned` | |
| F-2.2 | Running balance + virtualized list | 2.2 | `planned` | |
| F-2.3 | Clear / reconcile + statement ending balance | 2.3 | `planned` | |
...
| F-5.1 | Polish, empty states, idle lock | 5.1 | `planned` | |
